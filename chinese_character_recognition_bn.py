...
#    with tf.device('/gpu:0'):
    ...
    predicted_val_top_k, predicted_index_top_k = tf.nn.top_k(probabilities, k=top_k, name="top_k")
        ...
        try:
            ...
            while not coord.should_stop():
                ...
                if step % FLAGS.save_steps == 1:
                    ...
                    tf.train.write_graph(sess.graph.as_graph_def(), "./models/", model_name + str(step) + ".pb", as_text=False)
...
def main(_):
    ...
    if FLAGS.mode == "train":
        ...
        image_path = '../data/test/00031/70110.png'
